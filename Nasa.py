...
Api_Key = "yaEdjo7saQa6po2YkpJLcEb2roD3SP0BXyCQmdLO"
...
def NasaNews(Date):
    ...
    Path_2 = "C:\\Users\\HP\\OneDrive\\Desktop\\New Jarvis\\DataBase\\NasaDataBase\\" + str(FileName)
...
def Summary(Boby):
    ...
    path = "C:\\Users\\HP\\OneDrive\\Desktop\\New Jarvis\\DataBase\\NasaDataBase\\Images Used\\" + str(value) + ".jpg"
...
def MarsImage():
    ...
    try:
        ...
        for index , photo in enumerate(Photos):
            ...
            Path_1 = "C:\\Users\\HP\\OneDrive\\Desktop\\New Jarvis\\" + str(img)

            Path_2 = "C:\\Users\\HP\\OneDrive\\Desktop\\New Jarvis\\DataBase\\NasaDataBase\\MarsImage\\" + str(img)
...
def Astro(start_date,end_date):
    ...
    url =  ( f"https://api.nasa.gov/neo/rest/v1/feed?start_date={start_date}&end_date={end_date}&api_key={k}")
    r = requests.get(url)
