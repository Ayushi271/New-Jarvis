...
extracted_time = open('C:\\Users\\HP\\OneDrive\\Desktop\\New Jarvis\\Data.txt','rt')
time = extracted_time.read()
Time = str(time)

delete_time = open("C:\\Users\\HP\\OneDrive\\Desktop\\New Jarvis\\Data.txt",'r+')
...
def RingerNow(time):
    ...
    while True:
        ...
        if current_time == Alarm_Time:
            ...
            playsound("C:\\Users\\HP\\OneDrive\\Desktop\\New Jarvis\\DataBase\\Sounds\\1.mp3")
