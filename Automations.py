...
def YouTubeAuto(command):
    ...
    if 'pause' in query:
        ...
        web.open("https://www.youtube.com/watch?v=BddP6PYo2gs")
...
def GoogleMaps(Place):
    ...
    Speak(target)
    Speak(f"Ma'am , {Place} iS {distance} Kilometre Away From Your Location . ")

def OnlinClass(Subject):

    Speak("Joining The Class Ma'am.")

    if 'algorithm' in Subject:

        from DataBase.OnlineClasses.Links import Algorithm
        ...
        Speak("Class Joined Ma'am. Work hard today. ")

    elif 'compiler' in Subject:

        from DataBase.OnlineClasses.Links import Compiler
        ...
        Speak("Class Joined Ma'am. Start to study")

    elif 'dbms' in Subject:

        from DataBase.OnlineClasses.Links import DBMS
        ...
        Speak("Class Joined Ayushi. Get ready for study")

    elif 'itcs' in Subject:

        from DataBase.OnlineClasses.Links import ITCS
        ...
        Speak("Class Joined Ayushi. Now it is time to study")
...
def Notepad():
    ...
    path_1 = "C:\\Users\\HP\\OneDrive\\Desktop\\New Jarvis\\" + str(filename)

    path_2 = "C:\\Users\\HP\\OneDrive\Desktop\\New Jarvis\\Database" + str(filename)
